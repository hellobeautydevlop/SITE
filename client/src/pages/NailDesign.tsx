...
export default function NailDesign() {
  ...
  const services = [
    ...
    {
      name: "Acrylic Nails",
      description: "Durable, sculptured nails with custom designs",
      price: "$40 - $65",
    ...
    },
    {
      ...
      description: "Classic elegant look with white tips",
      price: "$30 - $45",
      duration: "45 minutes - 1 hour",
      details: [
        "Classic design",
        "Timeless elegance",
        "Gel or polish options",
        "Perfect for any occasion",
      ],
    },
    {
      name: "Ombre Nails",
      description: "Gradient color effect for modern style",
      price: "$45 - $70",
      duration: "1-1.5 hours",
      details: [
        "Gradient blending",
    ...
    },
    {
      ...
      description: "Touch-ups and repairs for existing nails",
      price: "$15 - $30",
