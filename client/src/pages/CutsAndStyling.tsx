      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 via-accent/5 to-primary/10 border-y border-accent/20">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
              Every client is unique. Our master stylists offer free consultations to discuss your hair goals, assess your hair type, and provide accurate pricing for your custom cut and style.
            </p>
