...
import { Phone, MapPin, Clock, Scissors, Sparkles, Palette, Star, Instagram, ArrowRight, Mail, Facebook, Linkedin, Twitter } from "lucide-react";
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="relative h-96 rounded-xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4882.409713928075!2d-113.81135974641876!3d52.2759827619041!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53745431017e59dd%3A0x777a3cd00b0f179d!2sHello%20Beauty%20Lounge!5e0!3m2!1sen!2sca!4v1783370441593!5m2!1sen!2sca"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
