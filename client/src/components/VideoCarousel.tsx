...
const videoTestimonials: VideoTestimonial[] = [
  {
    ...
    quote: "Noon transformed my hair with the most beautiful balayage!",
  },
  {
    id: "2",
    ...
    quote: "Melissa is an extension expert! My hair looks so full and healthy.",
  },
  {
    id: "3",
    name: "Jessica Chen",
    ...
    quote: "Tiara gave me the perfect cut that flatters my face shape.",
  },
  {
    id: "4",
    name: "Amanda Foster",
